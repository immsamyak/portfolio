      ...
      <section className="pt-16 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-slate-900 dark:text-white mb-6">
            Hi, I'm <span className="text-indigo-600 dark:text-indigo-400">Samyak Chaudahry</span>
          </h1>
          ...
          <p className="text-lg text-slate-500 dark:text-slate-300 mb-8 max-w-2xl mx-auto">
            3+ years in full-stack web and mobile app development. I build SaaS products, AI-powered apps, and creative digital solutions. Currently studying Computer Science (Cybersecurity & Networking) in Malaysia.
          </p>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-800">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-6">
            Building Digital Solutions & Experiences
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-200 leading-relaxed">
            I specialize in cross-platform apps, SaaS, and web solutions using Flutter, Laravel, MERN, and more. Passionate about cybersecurity, AI, and creative storytelling. Let's build something impactful together!
          </p>
        </div>
      </section>
